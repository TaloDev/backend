...
export default class PlayerAuthCode extends Mail {
  constructor(alias: PlayerAlias, code: string) {
    super(
      ...
      `Your ${alias.player.game.name} verification code`,
      `Hi ${alias.identifier}, here's your verification code to login to ${alias.player.game.name}.`,
    )
    ...
    this.footerText =
      'Your account is still secure, however, you should update your password as soon as possible.'
