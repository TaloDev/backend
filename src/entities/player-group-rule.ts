...
type RuleNamespace =
  | typeof propWithKeyNamespace
  | typeof statValueNamespace
  | typeof leaderboardEntryScoreNamespace

export type PlayerGroupRuleField =
  | keyof Player
...
export default class PlayerGroupRule {
  ...
  private isPropsNotSetQuery() {
    return (
      this.name === PlayerGroupRuleName.SET && this.negate && this.fieldMatchesNamespace('props')
    )
  }
