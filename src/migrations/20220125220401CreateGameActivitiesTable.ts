...
export class CreateGameActivitiesTable extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table `game_activity` (`id` int unsigned not null auto_increment primary key, `game_id` int(11) unsigned not null, `user_id` int(11) unsigned not null, `type` tinyint not null, `extra` json not null, `created_at` datetime not null, `updated_at` datetime not null) default character set utf8mb4 engine = InnoDB;')
