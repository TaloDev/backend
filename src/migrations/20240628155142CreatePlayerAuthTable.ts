...
export class CreatePlayerAuthTable extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      "alter table `player_alias` modify `service` enum('steam', 'epic', 'username', 'email', 'custom', 'talo') not null;",
    )
  }
