...
export class AddCascadeDeleteRules extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(
      'alter table `leaderboard_entry_prop` drop foreign key `leaderboard_entry_prop_entry_id_foreign`;',
    )
    ...
    this.addSql(
      'alter table `leaderboard_entry` modify `leaderboard_id` int unsigned not null, modify `player_alias_id` int unsigned not null;',
    )
    this.addSql(
    ...
    this.addSql(
      'alter table `player_game_stat` modify `player_id` varchar(255) not null, modify `stat_id` int unsigned not null;',
    )
    this.addSql(
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(
      'alter table `player_prop` add constraint `player_prop_player_id_foreign` foreign key (`player_id`) references `player` (`id`) on update cascade;',
    )
    ...
    this.addSql(
      'alter table `player_alias` add constraint `player_alias_player_id_foreign` foreign key (`player_id`) references `player` (`id`) on update cascade;',
    )
    ...
    this.addSql(
      'alter table `game_save` add constraint `game_save_player_id_foreign` foreign key (`player_id`) references `player` (`id`) on update cascade;',
    )

    this.addSql(
      'alter table `leaderboard_entry` modify `leaderboard_id` int unsigned null, modify `player_alias_id` int unsigned null;',
    )
    this.addSql(
    ...
    this.addSql(
      'alter table `leaderboard_entry_prop` add constraint `leaderboard_entry_prop_leaderboard_entry_id_foreign` foreign key (`leaderboard_entry_id`) references `leaderboard_entry` (`id`) on update cascade;',
    )

    this.addSql(
      'alter table `player_game_stat` modify `player_id` varchar(255) null, modify `stat_id` int unsigned null;',
    )
    this.addSql(
