...
export class CreatePlayerAliasSubscriptionTable extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql('create table `player_alias_subscription` (`id` varchar(255) not null, `subscriber_id` int unsigned not null, `subscribed_to_id` int unsigned not null, `confirmed` tinyint(1) not null default false, `created_at` datetime not null, `updated_at` datetime not null, primary key (`id`)) default character set utf8mb4 engine = InnoDB;')
