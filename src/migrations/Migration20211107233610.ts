...
export class Migration20211107233610 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `leaderboard_entry` (`id` int unsigned not null auto_increment primary key, `score` double not null, `leaderboard_id` int(11) unsigned null, `player_alias_id` int(11) unsigned null, `created_at` datetime not null, `updated_at` datetime not null) default character set utf8mb4 engine = InnoDB;')
