...
export default class PlayerSubscriptionsAPIPolicy extends Policy {
  async getAlias() {
  ...
  async post(): Promise<PolicyResponse> {
    ...
    return await this.hasScope(APIKeyScope.WRITE_PLAYER_SUBSCRIPTIONS)
  }
  ...
  async getSubscribers(): Promise<PolicyResponse> {
    ...
    return await this.hasScope(APIKeyScope.READ_PLAYER_SUBSCRIPTIONS)
  }
